...
<?php
	...
	$resultado = mysqli_query($conexao, "select * from gestacao g inner join medicamentos m ON g.medicament = m.cod_med INNER join vacinas v on g.vacinas = m.cod_med");
